  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Government Portal Variants
        hero:
          "bg-gradient-to-r from-accent to-accent-light text-accent-foreground shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] font-semibold",
        govPrimary:
          "bg-gradient-to-r from-primary-dark via-primary to-info text-primary-foreground shadow-lg hover:shadow-xl hover:scale-[1.01] active:scale-[0.98] font-semibold",
        govOutline:
          "border-2 border-primary/30 bg-card text-foreground hover:border-primary hover:bg-primary/5 active:scale-[0.98]",
        success:
